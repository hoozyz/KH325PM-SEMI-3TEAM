...
public class ShowSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			if (req.getParameter("keyword").equals("") || req.getParameter("category").equals("")) {
				req.setAttribute("msg", "입력값을 다 입력해주세요.");
			...
			if (category.equals("뮤지컬") || category.equals("연극") || category.equals("무용")
					|| category.equals("복합")) {
				...
				return;
			} else if (category.equals("클래식") || category.equals("국악") || category.equals("오페라")) {
