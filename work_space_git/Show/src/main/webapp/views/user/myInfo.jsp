        ...
        <div class="bg-light shadow-sm rounded-3 p-4 p-md-5 mb-2">
          ...
          <div class="d-flex align-items-start justify-content-between pb-4 mb-2">
            <div class="d-flex align-items-start">
            	<div class="position-relative flex-shrink-0"><img class="rounded-circle" src="<%=path %>/resources/images/avatars.png" width="100" alt="Annette Black">
              </div>
            ...
            </div><a class="nav-link p-0 d-none d-md-block" onclick="location.href='<%=path %>/logout'"><i class="fi-logout mt-n1 me-2"></i>로그 아웃</a>
          </div>
          <!-- Account menu-->
          ...
          <div class="collapse d-md-block" id="account-nav">
            <ul class="nav nav-pills flex-column flex-md-row pt-3 pt-md-0 pb-md-4 border-bottom-md">
              <li class="nav-item mb-md-0 me-md-2 pe-md-1"><a class="nav-link active" onclick="location.href='<%=path %>/myInfo'" aria-current="page"><i class="fi-settings mt-n1 me-2 fs-base"></i>나의 정보</a></li>
          ...
          <form name="updateForm" action="<%=path%>/user/update" method="POST">
            ...
            <div class="row pt-4 mt-2">
                <div class="col-lg-9 offset-lg-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <input class="btn btn-primary rounded-pill px-3 px-sm-4" type="submit" id="updateUser" value="정보 변경">
