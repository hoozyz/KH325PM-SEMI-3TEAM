...
<main>
	...
	<div class="container content-overlay mb-md-4 py-5" style="margin-top:110px">
		<!-- Breadcrumb-->
		...
		<div class="bg-light shadow-sm rounded-3 p-4 p-md-5 mb-2" style="min-height: 1000px;">
			...
			<!-- Aci menu-->
			<a
				class="btn btn-outline-primary btn-lg rounded-pill w-100 d-md-none" href="#aci-nav" data-bs-toggle="collapse"><i class="fi-align-justify me-2"></i>회원 정보</a>
			<div class="collapse d-md-block" id="aci-nav">
              ...
              <li class="nav-item mb-md-0 me-md-2 pe-md-1" style="cursor:pointer; " ><a class="nav-link active" style="color:#AB69DD;" onclick="location.href='<%=path %>/myReview'" aria-current="page"><i class="fi-file mt-n1 me-2 fs-base"></i>나의 리뷰</a></li>
