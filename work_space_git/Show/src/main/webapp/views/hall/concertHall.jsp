            ...
            <div class="row">
                <div class="col-lg-6 py-2 p-xl-5">
                    ...
                    <% if(list != null) { %>
                    	...
                    	<% for (int i = 0; i < count; i++) { %>
                                ...
                                <div class="card-img-top overflow-hidden dark-overlay bg-cover" style="background-image: url(resources/images/concert-hall/000002.jpg); min-height: 200px;">
                ...
                <div class="col-lg-6">
                    ...
                    <script>
						...
						var options = {
							center: new kakao.maps.LatLng(33.450701, 126.570667), // 나중에 예술의 전당 la lo 가져오기.
							level: 3
						};
