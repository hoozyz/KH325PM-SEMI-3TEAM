...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=path %>/resources/css/rank.css">
            ...
            <div class="container">
                ...
                <% } else {%>
                	 ...
                	 <% } else if (loginUser != null && loginUser.getRole().equals("ROLE_USER")) {%>
               		 <button class="btn btn-sm  d none d-lg-block order-lg-3 mt-2" onclick="location.href='<%=path %>/myInfo'" data-bs-toggle="modal"style="color:#0B398E;font-size:20px"><i class="fi-user me-2"></i>마이페이지</button>
                	 <button class="btn btn-sm  d-none d-lg-block order-lg-3 mt-2" onclick="location.href='<%=path %>/logout'" data-bs-toggle="modal"style="color:#0B398E;font-size:20px"><i class="fi-user me-2"></i>로그아웃</button>
                	 <% } else {%>
               		 <button class="btn btn-sm  d none d-lg-block order-lg-3 mt-2" onclick="location.href='<%=path %>/myInfo'" data-bs-toggle="modal"style="color:#0B398E;font-size:20px"><i class="fi-user me-2"></i>마이페이지</button>
                	 <button class="btn btn-sm  d-none d-lg-block order-lg-3 mt-2" onclick="kakaoLogout();" data-bs-toggle="modal"style="color:#0B398E;font-size:20px"><i class="fi-user me-2"></i>로그아웃</button>
                	<% } %>
                <% } %>
                <div class="collapse navbar-collapse order-lg-2 mt-3" id="navbarNav">
                    <ul class="navbar-nav navbar-nav-scroll" style="max-height: 35rem;">
                        ...
                        <li class="nav-item dropdown ps-3"><a class="nav-link dropdown" href="<%=path %>/news?check=0" role="button" data-bs-toggle="dropdown" aria-expanded="false" id="NSR">게시판</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-it" href="<%=path%>/news">소식</a></li>
