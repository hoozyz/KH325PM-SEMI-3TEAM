...
<head>
    <meta charset="utf-8">
    <title>SCENE</title>
    <link rel="stylesheet" href="<%=path %>/resources/css/directory/style.default1.css" id="theme-stylesheet">
    <!-- Viewport-->
            ...
            <div class="container">
                ...
                <% } else {%>
                	 ...
                	 <% } else if (loginUser != null && loginUser.getRole().equals("ROLE_USER")) {%>
               		 <button class="btn btn-sm  d none d-lg-block order-lg-3 mt-3" onclick="location.href='<%=path %>/myInfo'" data-bs-toggle="modal"style="color:#0B398E;font-size:20px"><i class="fi-user me-2"></i>마이페이지</button>
                	 <button class="btn btn-sm  d-none d-lg-block order-lg-3 mt-3" onclick="location.href='<%=path %>/logout'" data-bs-toggle="modal"style="color:#0B398E;font-size:20px"><i class="fi-user me-2"></i>로그아웃</button>
                	 <% } else {%>
               		 <button class="btn btn-sm  d none d-lg-block order-lg-3 mt-3" onclick="location.href='<%=path %>/myInfo'" data-bs-toggle="modal"style="color:#0B398E;font-size:20px"><i class="fi-user me-2"></i>마이페이지</button>
                	 <button class="btn btn-sm  d-none d-lg-block order-lg-3 mt-3" onclick="kakaoLogout();" style="color:#0B398E;font-size:20px" data-bs-toggle="modal"><i class="fi-user me-2"></i>로그아웃</button>
                	<% } %>
                <% } %>
